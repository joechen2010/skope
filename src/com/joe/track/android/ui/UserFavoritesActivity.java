...
public class UserFavoritesActivity extends BaseActivity {	  
	...
	private OnItemClickListener mOOISelectListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> a, View v, int position, long id) {
			...
			if (ooi.getId() == getCache().getUser().getId()) {
		        ...
		        i.putExtras(bundle);i.setClassName("com.joe.track.android",
				...
				i.setClassName("com.joe.track.android",
						"com.joe.track.android.ui.OOIDetailMapActivity");
			}
			startActivity(i);
		}
	};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFavoritesListAdapter = new ObjectOfInterestArrayAdapter(UserFavoritesActivity.this, R.layout.track_view, mFavoritesList);
	...
	public void onResume() {
		...
		if (checkCacheSanity()) {
			...
			Bundle bundle = new Bundle();
			if (getIntent() != null && getIntent().getExtras() != null) {
				userId = getIntent().getExtras().getLong(TrackApplication.BUNDLEKEY_USERID);
			} else {
