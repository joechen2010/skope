...
public class UserChatsActivity extends BaseActivity {	  
	...
	private OnItemClickListener mOOISelectListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> a, View v, int position, long id) {
	        ...
	        bundle.putParcelable(TrackApplication.BUNDLEKEY_USER, ooi);
	        i.putExtras(bundle);
			i.setClassName("com.joe.track.android","com.joe.track.android.ui.OOIChatActivity");
			startActivity(i);
		}
	};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mChatsListAdapter = new ObjectOfInterestArrayAdapter(UserChatsActivity.this, R.layout.track_view, mChatsList);
	...
	private void requestChatUsersUpdate() {
		...
		bundle.putLong(TrackApplication.BUNDLEKEY_USERID, userId);
    	...
    	switch (type) {
            ...
            case READ_USER_CHATS_END:
            	...
            	for (User ooi: mChatsList) {
                	...
                	messagesBundle.putLong(TrackApplication.BUNDLEKEY_USERID, ooi.getId());
                	//messagesBundle.putBoolean(TrackApplication.BUNDLEKEY_CHAT_FROM, true);
                	messagesBundle.putBoolean(TrackApplication.BUNDLEKEY_CHAT_LAST, true);
            	...
            	for (User ooi: mChatsList) {
            		Bundle messagesBundle = new Bundle();
                	messagesBundle.putLong(TrackApplication.BUNDLEKEY_USERID, ooi.getId());
                	messagesBundle.putBoolean(TrackApplication.BUNDLEKEY_CHAT_UNREAD, true);
                	messagesBundle.putBoolean(TrackApplication.BUNDLEKEY_CHAT_FROM, true);
                	getServiceQueue().postToService(Type.READ_USER_CHAT_MESSAGES, messagesBundle);
            	}
    		...
    		case READ_USER_CHAT_MESSAGES_END:
    			...
    			User ooi = getCache().getUserChatsList().
    							getById(bundle.getInt(TrackApplication.BUNDLEKEY_USERID));
    			...
    			if (bundle.containsKey(TrackApplication.BUNDLEKEY_CHAT_UNREAD)) {
    				isUnreadMessages = bundle.getBoolean(TrackApplication.BUNDLEKEY_CHAT_UNREAD);
    			}		
