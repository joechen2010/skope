...
public class LoginActivity extends BaseActivity {
	...
	public void onCreate(Bundle icicle) {
		...
		signup.setOnClickListener(new OnClickListener() {
			public void onClick(View viewParam) {
		        ...
		        Intent i = new Intent();
	        	i.setClassName("com.joe.track.android",
	        				   "com.joe.track.android.ui.UserSignupActivity");
	        	startActivity(i);
			}
		});
	...
	private int login(String username, String password) {
    	...
    	editor.putString(TrackApplication.PREFS_USERNAME, mUsername);
    	editor.putString(TrackApplication.PREFS_PASSWORD, mPassword);
    	editor.putLong(TrackApplication.PREFS_USERID, user.getId());
    	
    	// Store preference defaults
        editor.putBoolean(TrackApplication.PREFS_GPSENABLED, true);
    	editor.commit();

    	// Retrieve favorites
        Bundle favoritesBundle = new Bundle();
        favoritesBundle.putLong(TrackApplication.BUNDLEKEY_USERID, user.getId());
	...
	private class LoginTask extends AsyncTask<String, Void, Integer> {
	    ...
	    protected void onPostExecute(Integer httpResponseCode) {
	    	...
	    	if (handleLoginResultCode(httpResponseCode)) {
		        ...
		        bundle.putInt(TrackApplication.BUNDLEKEY_TAB, MainTabActivity.TAB_PROFILE);
		        Intent i = new Intent();
		        	i.setClassName("com.joe.track.android",
				   "com.joe.track.android.ui.MainTabActivity");
		        	i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
