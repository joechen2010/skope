...
/**
 * This class represents the Track 'options' menu.
 * 
 ...
 */
public class TrackPreferenceActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            mPreferences = getSharedPreferences("trackPreferences", Context.MODE_WORLD_READABLE);
            ...
            mGPSLocalPreference.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            	public boolean onPreferenceClick(Preference preference) {
                	...
                	editor.putBoolean(TrackApplication.PREFS_GPSENABLED, 
    ...
    protected void onResume() {
		...
		if (mLocationManager.isProviderEnabled(android.location.LocationManager.GPS_PROVIDER)) {
	        ...
	        mGPSLocalPreference.setChecked(mPreferences.getBoolean(TrackApplication.PREFS_GPSENABLED, false));
		} else {
