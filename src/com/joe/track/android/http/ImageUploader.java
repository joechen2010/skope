package com.joe.track.android.http;
...
public class ImageUploader {
	...
	public ImageUploader(Context context, Cache cache) {
		mContext = context;
		mCache = cache;
		mUsername = mCache.getPreferences().getString(TrackApplication.PREFS_USERNAME, "");
		mPassword = mCache.getPreferences().getString(TrackApplication.PREFS_PASSWORD, "");
