...
public class TrackMapView extends MapView {
	...
	public TrackMapView(android.content.Context context, android.util.AttributeSet attrs) {
		super(context, attrs);
	}

	 public TrackMapView(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
		 super(context, attrs, defStyle);
	}

	public TrackMapView(android.content.Context context, java.lang.String apiKey) {
