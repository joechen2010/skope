...
import com.joe.track.android.ui.MainTabActivity;
...
public class LocationService extends Service implements LocationListener  {
	...
	public void onCreate() {
        ...
        Log.i(TAG, "LocationService.onCreate() " + "Track["
                + trackApplication + "]");
        mCache = trackApplication.getCache();
        mUiQueue = trackApplication.getUiQueue();
        mServiceQueue = trackApplication.getServiceQueue();
	...
	public  String saveUser(UserPhoneInfo userPhoneInfo){
	 ...
	 public com.joe.track.android.gps.Location purseLocationDetail(UserPhoneInfo userPhoneInfo,DetectType type){
		 String params = "";
		try {
